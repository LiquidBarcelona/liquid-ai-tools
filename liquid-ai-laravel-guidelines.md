...
This file contains Laravel and PHP coding standards optimized for AI code assistants like Claude Code, GitHub Copilot, and Cursor. These guidelines are derived from Laravel & PHP standards.
...
### Core Rules
 ...
 - Avoid “fat controllers” — delegate logic to dedicated layers
 - Import all classes explicitly instead of using fully qualified names inline
 - Keep code clear, consistent, and easy to reason about — readability is the top priority
### Functions & Methods
 - Keep methods short — ideally fitting on screen without scrolling
 - Each function should have a single, well-defined responsibility.
 - Avoid complex anonymous functions or closures — use them only when they are very direct and easy to read
### Dependencies & Injection
  - Prefer constructor or method injection.
  - When using app() in closures/helpers, add a short comment explaining why DI isn’t feasible.
...
- **Early Return & Continue** Use early return or continue only at the beginning of a block (as preconditions). Avoid them in the middle of logic.
